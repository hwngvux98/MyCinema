...
export function getMovieRecommendation(id) {
  return `${TMDB_ENDPOINT}/movie/${id}/recommendations?language=en-US&page=1&api_key=${TMDB_API_KEY}`
}

export function getTVSeriesRecommendation(id) {
  return `${TMDB_ENDPOINT}/tv/${id}/recommendations?language=en-US&page=1&api_key=${TMDB_API_KEY}`
}

export function getTVSeriesSeasonDetail(id, seasonNum) {
  return `${TMDB_ENDPOINT}/tv/${id}/season/${seasonNum}?language=en-US&api_key=${TMDB_API_KEY}`
}
